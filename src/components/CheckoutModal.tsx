import { MapPin, Phone, CheckCircle2, Bike, UtensilsCrossed } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-white">
            #{order.id ? order.id.slice(-4) : "0000"}
          </h3>
        </div>
          ...
          {[
            ...
            <div key={i} className="flex items-start gap-3">
              ...
              <div className="pt-0.5">
                <p className={`text-sm font-medium ${step.done ? "text-slate-900 dark:text-white" : "text-slate-400"}`}>
                  {step.label}
                </p>
              </div>
            </div>
